...
ы
Сценарий: Загрузка данных документа Заказ

* Загрузка тестовых данных документа Заказ
		// Справочник.Валюты
	...
	И я проверяю или создаю для документа "Заказ" объекты:
		...
		| 'e1cib/data/Документ.Заказ?ref=aa1690e868ae02f011f041de54f220fb' | 'False'           | '000000037' | '05.06.2025 10:26:04' | 'True'     | 'e1cib/data/Справочник.Контрагенты?ref=a9b000055d49b45e11db8e8bd1cb82a7' | 'e1cib/data/Справочник.Склады?ref=a9b000055d49b45e11db8b8bdc1aadc2' | 'e1cib/data/Справочник.Валюты?ref=a9b000055d49b45e11db8c4421dda1c5' | 'e1cib/data/Справочник.ВидыЦен?refName=Закупочная' | 'e1cib/data/Справочник.Организации?ref=8d34000d8843cd1b11dd2bea12f94c64' | 'Enum.СостоянияЗаказов.Открыт' | 'e1cib/data/Справочник.Пользователи?ref=a2bc001d600da75a11e1f76a026436bc' | 500     |
		| 'e1cib/data/Документ.Заказ?ref=aa1590e868ae02f011f03d641b5be99a' | 'False'           | '000000029' | '30.05.2025 17:41:04' | 'False'    | 'e1cib/data/Справочник.Контрагенты?ref=a9b000055d49b45e11db8e8bd1cb82a7' | 'e1cib/data/Справочник.Склады?ref=a9b000055d49b45e11db8b8bdc1aadc2' | 'e1cib/data/Справочник.Валюты?ref=a9b000055d49b45e11db8c4421dda1c5' | 'e1cib/data/Справочник.ВидыЦен?refName=Закупочная' | 'e1cib/data/Справочник.Организации?ref=8d34000d8843cd1b11dd2bea12f94c64' | 'Enum.СостоянияЗаказов.Открыт' | 'e1cib/data/Справочник.Пользователи?ref=a2bc001d600da75a11e1f76a026436bc' | 250     |
		| 'e1cib/data/Документ.Заказ?ref=aa1990e868ae02f011f045297850d9c4' | 'False'           | '000000041' | '09.06.2025 15:01:30' | 'True'     | 'e1cib/data/Справочник.Контрагенты?ref=a9b000055d49b45e11db8e8bd1cb82a7' | 'e1cib/data/Справочник.Склады?ref=a9b000055d49b45e11db8b8bdc1aadc2' | 'e1cib/data/Справочник.Валюты?ref=a9b000055d49b45e11db8c4421dda1c5' | 'e1cib/data/Справочник.ВидыЦен?refName=Закупочная' | 'e1cib/data/Справочник.Организации?ref=8d34000d8843cd1b11dd2bea12f94c64' | 'Enum.СостоянияЗаказов.Открыт' | 'e1cib/data/Справочник.Пользователи?ref=a2bc001d600da75a11e1f76a026436bc' | 500     |

	И я перезаполняю для объекта табличную часть "Товары":
		| 'Ссылка'                                                         | 'Товар'                                                             | 'Цена' | 'Количество' | 'Сумма' |
		| 'e1cib/data/Документ.Заказ?ref=aa1690e868ae02f011f041de54f220fb' | 'e1cib/data/Справочник.Товары?ref=8ca1000d8843cd1b11dc8ea92d97a749' | 250    | 2            | 500     |
		| 'e1cib/data/Документ.Заказ?ref=aa1590e868ae02f011f03d641b5be99a' | 'e1cib/data/Справочник.Товары?ref=8ca1000d8843cd1b11dc8ea92d97a749' | 250    | 1            | 250     |
		| 'e1cib/data/Документ.Заказ?ref=aa1990e868ae02f011f045297850d9c4' | 'e1cib/data/Справочник.Товары?ref=8ca1000d8843cd1b11dc8ea92d97a749' | 250    | 2            | 500     |

Сценарий: Запуск эскпортного сценария

	И Заполнение шапки документа Заказ
	И Заполнение табличной части документа Заказ